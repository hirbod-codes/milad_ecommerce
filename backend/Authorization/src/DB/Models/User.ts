...
for (const field in userUpdateSchema.fields)
    if (Object.prototype.hasOwnProperty.call(userUpdateSchema.fields, field))
        (userUpdateSchema.fields as any)[field] = (userUpdateSchema.fields as any)[field].optional()
