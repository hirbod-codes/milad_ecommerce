        ...
        <Stack direction="vertical" stackProps={{ className: 'justify-between size-full' }}>
            ...
            <Stack direction="vertical">
                ...
                <Stack stackProps={{ className: 'items-center w-full' }}>
                    <Button variant='outline' className='flex-grow' onClick={async () => { await EmailAuthenticationManager.googleOAuth2() }}><img src={GoogleIcon} width={24} alt="Google Logo" /> {t('common.google')}</Button>
                </Stack>
            </Stack>
        </Stack>
    )
