...
export function Stack({ children, direction = 'horizontal', size = 3, stackProps, stackRef }: { children?: ReactNode, size?: number, direction?: 'vertical' | 'horizontal', stackProps?: ComponentProps<'div'>, stackRef?: RefObject<HTMLDivElement> }) {
